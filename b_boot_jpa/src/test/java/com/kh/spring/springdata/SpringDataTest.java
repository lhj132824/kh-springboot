...
public class SpringDataTest {
	...
	public void countByBookAmtGreaterThanEqual() {
		log.info("도서 재고가 2권 이상인 도서 조회 : " + springDataRepository.countByBookAmtGreaterThanEqual(2));
	}
	
	@Test
	@DisplayName("도서 재고가 10권 이상인 도서가 존재하는지 확인")
	public void existsBy() {
		log.info("도서 재고가 10권 이상인 도서가 존재하는지 확인 : " + springDataRepository.existsByBookAmtGreaterThanEqual(10));
	}
